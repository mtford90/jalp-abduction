...
public class NegativeConstraintTest {
    ...
    */
    @Test
    public void inIntegerTest1() throws IOException, ParseException, JALPException, uk.co.mtford.jalp.abduction.parse.query.ParseException {
    ...
    */
    @Test
    public void inIntegerTest2() throws IOException, ParseException, JALPException, uk.co.mtford.jalp.abduction.parse.query.ParseException {
        system = new JALPSystem("examples/constraint/negative/in-integer.alp");
        List<IInferableInstance> query = new LinkedList<IInferableInstance>();
    ...
    @Test
    public void inConstantListTest1() throws IOException, ParseException, JALPException, uk.co.mtford.jalp.abduction.parse.query.ParseException {
    ...
    @Test
    public void inConstantListTest2() throws IOException, ParseException, JALPException, uk.co.mtford.jalp.abduction.parse.query.ParseException {
        system = new JALPSystem("examples/constraint/negative/in-constant-list.alp");
        List<IInferableInstance> query = new LinkedList<IInferableInstance>();
