/* Generated By:JavaCC: Do not edit this line. ALPQueryParser.java */
package uk.co.mtford.alp.abduction.parse.query;
...
public class ALPQueryParser implements ALPQueryParserConstants {

    public static List<PredicateInstance> readFromString(String string) throws ParseException {
        ByteArrayInputStream inputStream = null;
        byte[] buf = string.getBytes();
        inputStream = new ByteArrayInputStream(buf);
        ALPQueryParser parser = new ALPQueryParser(inputStream);
        return parser.AbductiveLogicQuery();
    }

  final public List<PredicateInstance> AbductiveLogicQuery() throws ParseException {
  ...
  public ALPQueryParserTokenManager token_source;
  ...
  public ALPQueryParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ALPQueryParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new ALPQueryParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public ALPQueryParser(java.io.Reader stream) {
  ...
  public ALPQueryParser(ALPQueryParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(ALPQueryParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
